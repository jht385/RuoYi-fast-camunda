...
public class RoleServiceImpl implements IRoleService
{
    ...
    public boolean deleteRoleById(Long roleId)
    {
        ...
        processDefinitionMapper.deleteProcdefKeyByRoleId(roleId);
    ...
    public int updateRole(Role role)
    {
        ...
        processDefinitionMapper.deleteProcdefKeyByRoleId(role.getRoleId());
        insertRoleProcdef(role);
        return insertRoleMenu(role);
    }
    ...
    private int insertRoleProcdef(Role role) {
        int rows = 1;
        List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
        for (String procdefKey : role.getProcdefKeys())
        {
            Map<String, Object> temp = new HashMap<String, Object>();
            temp.put("id", String.valueOf(idGeneratorSnowflake.nextId()));
            temp.put("roleId", role.getRoleId());
            temp.put("procdefKey", procdefKey);
            list.add(temp);
        }
        if (list.size() > 0)
        {
            rows = processDefinitionMapper.batchProcdefKey(list);
        }
        return rows;
    }
}
